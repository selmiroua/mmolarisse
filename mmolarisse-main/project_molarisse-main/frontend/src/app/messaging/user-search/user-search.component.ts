    ...
    <div class="user-search-container">
      ...
      <div class="search-form">
        <mat-form-field appearance="outline" class="search-input">
          <mat-label>Rechercher un patient ou secrétaire</mat-label>
          <input 
            matInput 
            [(ngModel)]="searchQuery" 
      ...
      <div *ngIf="!loading && filteredUsers.length === 0" class="empty-state">
        ...
        <p class="empty-subtitle" *ngIf="!searchQuery">Aucun patient ou secrétaire disponible</p>
      </div>
...
export class UserSearchComponent implements OnInit {
  ...
  filterUsers(): void {
    ...
    // Update secretaires and patients arrays based on filtered results
